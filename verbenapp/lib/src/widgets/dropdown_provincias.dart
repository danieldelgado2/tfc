...
class DropDownProvincias extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DropdownSearch<Provincia>(
      ...
      onFind: Provider.ofFormMapa(context).getProvinciasFiltradas,
      items: provincias,
      itemAsString: (Provincia p) => p.nombre,
      onChanged: (value) {
        Provider.ofFormMapa(context).changeProvinciaSeleccionada(value);
        Provider.ofFormMapa(context).changeCambiosBusqueda(true);
      },
      dropDownButton: Text(''),
    );
  }
